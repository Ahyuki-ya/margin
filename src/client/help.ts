  ...
  return `
    <div class="help">
      ...
      <ul>
        ...
        <li>卓の中央に、4 人の風と点数がそれぞれの席の方向に出ます。手番の人の点数が黄色く光ります。</li>
        <li>河で黄色い枠がついているのが、直前に捨てられた牌です。ドラ表示牌は左上に出ます。</li>
        <li>局が終わると結果が出ます。「次へ」で次の局に進みます。</li>
      </ul>

      <h4>設定（≡ メニュー）</h4>
      <ul>
        <li><b>対局画面の向き</b>（スマホ）：横・縦。横にすると、端末の回転ロック中でも対局画面を横向きに表示します（端末を左に倒して持ってください）。タイトル画面は端末の向きのまま表示します。</li>
        <li><b>文字の大きさ</b>：小・中・大・特大。点数・局・ボタン・結果画面などの文字が大きくなります（タイトル画面でも選べます）。</li>
